...
- 前端：Streamlit + st-aggrid（AG Grid 可编辑表格，宽屏本地 Web 应用）
...
| 文件 | 职责 |
| --- | --- |
| `app.py` | 页面路由、会话状态、AG Grid 表格编辑、筛选、表单、图表与中文 UI。 |
...
- 流水列表使用 AG Grid 支持可编辑下拉与整行状态色：待报销公费淡红、已结清公费淡绿；分类必须随收支类型提供对应选项。
